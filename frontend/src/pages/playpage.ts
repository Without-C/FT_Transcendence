	...
	<div class="flex flex-col items-end min-h-screen justify-center">
		<nav class="h-[60vh] flex flex-col items-end justify-center w-4/5 gap-6 lg:gap-7 xl:gap-8 2xl:gap-9">
			...
			<div class="flex items-center gap-4">
				<span class="text-5xl lg:text-8xl xl:text-13xl 2xl:text-17xl font-bold text-pink-300">1vs1</span>
				<div>
			...
			<div class="flex items-center gap-4">
				<span class="text-5xl lg:text-8xl xl:text-13xl 2xl:text-17xl font-bold text-green-300">TN</span>
				<div>
