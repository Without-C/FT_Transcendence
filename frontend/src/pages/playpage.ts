	...
	<div class="flex flex-col items-end min-h-screen justify-center">
		<nav class="h-[60vh] flex flex-col items-end justify-center w-4/5 gap-6 lg:gap-7 xl:gap-8 2xl:gap-9">
			...
			<div class="flex items-center gap-4">
				<span class="text-5xl lg:text-8xl xl:text-13xl 2xl:text-17xl font-bold text-pink-300 whitespace-nowrap min-w-[6rem] lg:min-w-[10rem] xl:min-w-[12rem] 2xl:min-w-[15rem] text-center">1vs1</span>
				<div>
				<h3 class="text-2xl lg:text-3xl xl:text-5xl 2xl:text-7xl font-bold">ONE-VS-ONE</h3>
			...
			<div class="flex items-center gap-4">
				<span class="text-5xl lg:text-8xl xl:text-13xl 2xl:text-17xl font-bold text-green-300 whitespace-nowrap min-w-[6rem] lg:min-w-[10rem] xl:min-w-[12rem] 2xl:min-w-[15rem] text-center">TN</span>
				<div>
				<h3 class="text-2xl lg:text-3xl xl:text-5xl 2xl:text-7xl font-bold">TOURNAMENT</h3>
